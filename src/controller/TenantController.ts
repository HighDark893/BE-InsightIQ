...
import { authorize, getUserInfo, requireAuthentication } from '../middleware/auth.middleware';
...
router.post('/update', requireAuthentication, authorize(['SUPERADMIN', 'TENANT']), async (req: Request, res: Response) => {
  try {
    const tenantDto: TenantDto = req.body;
...
router.delete('/delete', requireAuthentication, authorize(['SUPERADMIN']), async (req: Request, res: Response) => {
  try {
    const tenantDto: TenantDto = req.body;
...
router.get('/', requireAuthentication, authorize(['SUPERADMIN']), async(req: Request, res: Response) => {
  try {
